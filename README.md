...
При 1 000 точек на серию график и tooltip остаются рабочими, но столбцы визуально становятся плотными, scaling и увеличения длины периода X не делались.
...
Поддерживаются актуальные desktop-версии Chrome, Firefox, Edge и Safari; Internet Explorer и устаревшие браузеры не поддерживаются. График занимает 100% ширины родительского контейнера и адаптируется к его resize без remount. Контрольные viewport: 1440 × 900, 768 × 1024 и 390 × 844.
